...
namespace Leap.Unity
{
    ...
    public class LeapServiceProviderEditor : CustomEditorBase
    {
        protected override void OnEnable()
        {
            ...
            var controllerTypeProperty = serializedObject.FindProperty("_controllerType");
            var controllerType = controllerTypeProperty.enumNames[controllerTypeProperty.enumValueIndex];
            specifyConditionalDrawing(() => controllerType == "Playback",
                                      "_playbackFiles");
        }
