...
namespace Leap.Unity
{
    ...
    public class LeapImageRetriever : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            LeapmotionController controller = _provider.GetLeapController();
            if (controller != null)
            {
        ...
        {
            LeapmotionController controller = null;
            do
            {
        ...
        private void onController(LeapmotionController controller)
        {
