...
namespace Leap.Unity
{
        ...
        */
        ...
        private Vector3 selectedDirection(Vector3 tipPosition)
        {
            switch (PointingType)
            {
                ...
                case PointingType.RelativeToTarget:
                    return TargetObject.transform.TransformDirection(PointingDirection);
    ...
    * @since 4.1.2
    */
    public enum PointingType { RelativeToCamera, RelativeToHorizon, RelativeToWorld, RelativeToTarget, AtTarget }
}
