...
namespace Leap.Unity
{
    ...
    public class LeapServiceProvider : LeapProvider
    {
        ...
        ControllerMode _controllerType = ControllerMode.Local;
        [SerializeField] [EditTimeOnly]
        public Transform _head;

        [Header("[Playback Controller Config]")]
        [SerializeField] [EditTimeOnly]
        protected string[] _playbackFiles;
    ...
    protected int BounceAmount = 70;
        ...
        protected LeapmotionController leap_controller_;
        ...
        public LeapmotionController GetLeapController()
        {
#if UNITY_EDITOR
        ...
        protected virtual void Update()
        {
            ...
            if (_frameOptimization == FrameOptimizationMode.ReusePhysicsForUpdate)
            {
                ...
                _smoothedTrackingLatency.Update((float)(this.leap_controller_.Now() - this.leap_controller_.FrameTimestamp()), Time.deltaTime);
#endif
            this.leap_controller_.OnUpdate();
            this.leap_controller_.Frame(_untransformedUpdateFrame, false);
        ...
        protected virtual void FixedUpdate()
        {
            ...
            this.leap_controller_.OnFixedUpdate();
            this.leap_controller_.Frame(_untransformedFixedFrame, true);
      ...
      return leap_controller_.Now() - 16000;
        ...
        protected void createController()
        {
            ...
            {
                case ControllerMode.Local:
                    this.leap_controller_ = new LocalLeapmotionController();
                    break;

                case ControllerMode.Remote:
                    this.leap_controller_ = new LeapRemoteController("127.0.0.1", 9997, 9998);
                    break;

                case ControllerMode.Playback:
                    this.leap_controller_ = new LeapmotionPlaybackController(this._head, this._playbackFiles);
                    break;
            }
        ...
        protected void transformFrame(Frame source, Frame dest, bool resampleTemporalWarping = true)
        {
            ...
            if (this._controllerType == ControllerMode.Local && _temporalWarping != null)
            {
            ...
            else if(this._controllerType == ControllerMode.Remote)
            {
            ...
            {
                leapTransform = transform.GetLeapMatrix();
                //leapTransform.rotation = (this._head.rotation * leapTransform.rotation.ToQuaternion()).ToLeapQuaternion();
