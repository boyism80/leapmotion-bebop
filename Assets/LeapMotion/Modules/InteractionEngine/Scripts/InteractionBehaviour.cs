    ...
    public Rigidbody rigidbody
        ...
        protected virtual void OnEnable()
        {
            if (manager == null)
            {
                ...
                //if (manager == null)
                //{
                Debug.LogWarningFormat(this, "Interaction Behaviours require an Interaction Manager. Please "
                                           + "ensure you have an InteractionManager in your scene. ({0})", this.gameObject.name);
                this.enabled = false;
                //}
            }
