...
namespace Leap.Unity.Interaction
{
                                                  ...
                                                  IInternalInteractionController
    {
        ...
        protected virtual void Start()
        {
            ...
            if(manager == null)
            {
                Debug.Log("[ActivityManager] No filter provided for this ActivityManager; no objects will ever be returned."
                        + "Please make sure you specify a non-null filter property of any ActivityManagers you wish to use.", this);
            }
        }
