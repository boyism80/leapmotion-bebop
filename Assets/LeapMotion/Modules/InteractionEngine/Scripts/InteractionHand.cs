    ...
    public class InteractionHand : InteractionController
    {
        ...
        protected override void Start()
        {
            ...
            if(this.manager != null)
                this.leapProvider = this.manager.LeapProvider;
            ...
            if (handDataMode == HandDataMode.Custom)
            {
                ...
                {
                    Debug.Log("handDataMode is set to Custom, but no provider is set! "
                ...
                {
                    Debug.Log("handDataMode is set to Custom, but no handAccessorFunc has "
